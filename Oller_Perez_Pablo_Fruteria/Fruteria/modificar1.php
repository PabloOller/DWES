    ...
    <div style="margin: auto; width: 800px; border-collapse: separate; border-spacing: 10px 5px;">
      ...
      <form action="modificar2.php" method="POST" style="border-collapse: separate; border-spacing: 10px 5px;">
        <div class="form-group">
          ...
          <input class="form-control" type="text" id="nombre" name="nombre" ; value="<?php echo $consulta[0] ?>"><br>
        </div>
        <div class="form-group">
          <label class="control-label">Precio por kg de la fruta: </label>
          <input class="form-control" type="number" id="precioKg" name="precioKg" value="<?php echo $consulta[1] ?>"><br>
        </div>
        <div class="form-group">
          <label class="control-label">Cantidad (en kg) de fruta: </label>
          <input class="form-control" type="number" id="cantidad" name="cantidad" value="<?php echo $consulta[2] ?>"><br>
        </div>
